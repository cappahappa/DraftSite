        ...
        <ul className="eps-reviews-track flex items-stretch gap-5 px-4 sm:gap-6 sm:px-8">
          {loop.map((r, i) => (
            ...
            >
              ...
              >
                <article className="flex h-full flex-col rounded-xl border border-white/10 bg-[#161616] p-6 transition-colors hover:border-primary/60 hover:bg-[#1a1a1a]">
                  ...
                  <div className="mt-5 flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-primary/80">
                    View on Google
