export const site = {
  ...
  tagline: "Professional Painting Services in Vero Beach, FL",
  description:
    "Elite Painting Solutions is a 5-star, locally owned painting company serving Vero Beach, Sebastian, and all of Indian River County, Florida. We deliver flawless interior and exterior finishes, factory-grade cabinet refinishing, and commercial painting backed by 30+ years of experience and a workmanship warranty on every job.",
  address: "Vero Beach, FL 32960",
  addressFull: "Vero Beach, FL 32960 — Serving Indian River County",
  cityRegion: "Vero Beach, Florida",
  googleReviewsUrl:
    "https://www.google.com/search?q=elite+painting+solutions+vero+beach&rlz=1C1UEAD_enUS1170US1170",
};
...
export const navAreas: Area[] = [
  { name: "Vero Beach", slug: "vero-beach" },
  { name: "Sebastian", slug: "sebastian" },
  { name: "Indian River Shores", slug: "indian-river-shores" },
  { name: "Fellsmere", slug: "fellsmere" },
  { name: "Wabasso", slug: "wabasso" },
  { name: "Roseland", slug: "roseland" },
  { name: "Winter Beach", slug: "winter-beach" },
  { name: "Gifford", slug: "gifford" },
...
export const reviews = [
  ...
  {
    name: "Monica Rulo",
    text: "Fantastic service and great results. My house was in pretty rough shape, the T1-11 siding was dry and I have no clue when it was last painted. The previous owners did not seal anything properly so the team spent an entire day caulking and prepping the house for paint. They took their time to seal and prime the house, they painted with both a sprayer and a roller to make sure there was full penetration to protect my home for several years. My house looks new again and I couldn't be happier. I hope I can pass on more work through word of mouth but I hope my review helps someone choose Elite because they did a phenomenal job.",
    rating: 5,
  },
  {
    name: "Robert Austill",
    text: "I had Michael and his guys with Elite Painting Solutions come by to paint the outside of my home and I was very impressed with how quickly they were able to complete the job and provide the quality that they did. They are definitely the team to call when you want it done right the first time.",
    rating: 5,
  },
  {
    name: "Steve R",
  ...
  {
    name: "Shawn",
    text: "So I contacted Elite Painting Solutions and they were very responsive and provided me with an excellent estimate. We agreed to terms and then they went to work transforming my home. Their ability to work together was amazing to watch and I would highly recommend them to anyone looking to have their home painted.",
    rating: 5,
  },
  {
    name: "Joe St_Eggbenedictus",
    text: "Elite Painting Solutions did an amazing job on the exterior of our home, as well as several jobs on the interior. Michael was fair in his prices, and very honest and helping us to save money or in places where we needed additional work. There were never any surprises, and he informed us of his intentions every step of the way, especially when there was extra work needed to do repairs for rotten wood around the house. We are more than pleased and impressed and all who look at our home love the work they did.",
    rating: 5,
  },
  {
    name: "sameet patel",
    text: "These guys did a great job, making my house look amazing and did it in a timely fashion. They are very knowledgeable and fixed so many things that the previous guy I hired missed and tried to cut corners with. I only wish I had called Elite first.",
    rating: 5,
  },
];
